...
class User {
    ...
    static async create(userData) {
        const { name, rank_id, service_no, unit_id, department_id, role_id, designation_id, parent_id, phone, mobile, alternative_mobile, email, password_hash } = userData;
        const query = `
      INSERT INTO users (
    ...
    static async findAll(options = {}) {
        try {
            const { page = 1, limit = 50, search = '', unit_id = '', department_id = '', role_id = '', parent_id, include_inactive = false } = options;
