...
class DashboardController {
    ...
    static async getDashboardStats(req, res, next) {
        try {
            ...
            const [totalContacts, activeConversations, onlineContacts, securityAlerts, recentActivity, conversationStats, userStats] = await Promise.all([
    ...
    static async getDashboardAnalytics(req, res, next) {
        try {
            ...
            const [userActivityChart, conversationChart, messageChart, securityChart] = await Promise.all([
