...
class UserController {
    ...
    static async createUser(req, res, next) {
        try {
            ...
            const { name, rank_id, service_no, unit_id, department_id, designation_id, phone, mobile, alternative_mobile, email, parent_id, role_id, password } = req.body;
            // Verify unit exists
    ...
    static async getAllUsers(req, res, _next) {
        try {
            const { page = 1, limit = 50, search = '', unit_id = '', department_id = '', role_id = '', parent_id = null, include_inactive = 'false' } = req.query;
            const options = {
                page: parseInt(page),
