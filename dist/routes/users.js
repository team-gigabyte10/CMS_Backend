...
router.post('/', authorize('Super_admin', 'Admin'), createUserValidation, UserController.createUser);
// PUT /api/users/:id - Update user (Admin and Super Admin only)
router.put('/:id', authorize('Super_admin', 'Admin'), updateUserValidation, UserController.updateUser);
