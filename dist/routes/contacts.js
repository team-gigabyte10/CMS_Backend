...
const { createContactValidation, updateContactValidation } = require('../middleware/contactValidation');
...
router.post('/', authorize('Super_admin', 'Admin'), createContactValidation, ContactController.createContact);
// PUT /api/contacts/:id - Update contact (Admin and Super Admin only)
router.put('/:id', authorize('Super_admin', 'Admin'), updateContactValidation, ContactController.updateContact);
// DELETE /api/contacts/:id - Delete contact (Super Admin only)
router.delete('/:id', authorize('Super_admin'), ContactController.deleteContact);
